...
### 2.2 Filter Chain (Cadeia de Filtros)
...
### 2.3 UserDetails e UserDetailsService
...
### 2.4 Criptografia de Senhas (PasswordEncoder / BCrypt)
...
### 2.5 Tokens e Autenticação Stateless (JWT)
...
### 2.6 Controle de Acesso a Rotas
