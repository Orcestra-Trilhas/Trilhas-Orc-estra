...
## 2. ORM: O Problema que o JPA Resolve
...
## 3. JPA, Hibernate e Spring Data JPA: Quem é Quem
...
## 6. Estratégias de Carregamento: LAZY vs. EAGER
...
## 7. Repositórios do Spring Data JPA
...
### 8.3 `Specification` (Consultas Dinâmicas)
